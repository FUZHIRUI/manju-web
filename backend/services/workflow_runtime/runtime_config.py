...
FENJING_QC_THINKING: str
FENJING_QC_REASONING_EFFORT: str
...
def load() -> None:
    ...
    global QC_THINKING
    global QC_REASONING_EFFORT
    global FENJING_THINKING
    global FENJING_REASONING_EFFORT
    global FENJING_QC_THINKING
    global FENJING_QC_REASONING_EFFORT
   ...
   #tos基础配置
    ...
    QC_THINKING = _get_env("QC_THINKING", config_defaults.DEFAULT_QC_THINKING) or ""
    QC_REASONING_EFFORT = _get_env("QC_REASONING_EFFORT", config_defaults.DEFAULT_QC_REASONING_EFFORT) or ""
